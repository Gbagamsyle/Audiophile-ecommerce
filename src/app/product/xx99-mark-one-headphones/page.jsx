...
import productImage from '../../../assets/product-xx99-mark-one-headphones/desktop/image-product.jpg';
...
const product = {
  ...
  price: 1750,
  features: `Boasting a sleek design and premium finish, the XX99 Mark I headphones deliver high-fidelity audio with a wide soundstage and exceptional clarity. The memory foam earcups provide comfort for long listening sessions, while the robust construction ensures durability.\n\nWith a detachable cable and foldable design, these headphones are perfect for both studio use and travel. The XX99 Mark I is the perfect blend of style, comfort, and performance for discerning listeners.
`,
  includes: [
